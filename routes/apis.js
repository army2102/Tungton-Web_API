  ...
  connection.query(
    ...
    (error, results, fields) => {
      ...
      if (!(results.length === 1)) {
        ...
        connection.query(
          querys.users.create,
          [name, birthday, gender, phonenumber, email, password],
          (error, results, fields) => {
            if (error)
              throw res.status(404).json({
                status: 1,
...
router
  ...
  .post((req, res) => {
    ...
    connection.query(
      querys.stores.isInTheDatabaseSpecificName,
      [storeName],
      (error, results, fields) => {
        if (error)
          throw res.status(404).json({
...
router
  ...
  .get((req, res) => {
    ...
    connection.query(
      querys.stores.isInTheDatabaseSpecificId,
      [storeId],
      (error, results, fields) => {
        if (error)
          throw res.status(404).json({
        ...
        if (results.length === 1) {
          ...
          connection.query(
            ...
            (error, results, fields) => {
              ...
              connection.query(
                querys.userInStores.getUserInStore,
                [storeId],
                (error, results, fields) => {
                  if (error)
                    throw res.status(404).json({
...
router
  ...
  .post((req, res) => {
    ...
    connection.query(
      querys.products.isInTheDatabaseSpecific,
      [productBarcode],
      (error, results, fields) => {
        if (error)
          throw res.status(404).json({
  ...
  .get((req, res) => {
    ...
    connection.query(
      querys.products.isInTheDatabase,
      (error, results, fields) => {
        if (error)
          throw res.status(404).json({
            status: 0,
        ...
        if (results.length === 1) {
          ...
          connection.query(
            ...
            (error, results, fields) => {
              ...
              productBarcodeEdit =
                productBarcodeEdit || results[0].productBarcode;
...
router
  .route('/products/:productBarcode/stores/:storeId')
    ...
    connection.query(
      ...
      (error, results, fields) => {
        ...
        if (results.length === 1) {
          ...
          connection.query(
            querys.productInStores.isInTheDatabase,
            [productId, storeId],
            (error, results, fields) => {
              if (error)
                throw res.status(404).json({
...
router.post('/stores/:storeId/receipts', (req, res) => {
  ...
  for (var i = 0; i < productDetail.length; i++) {
    ...
    connection.query(
      querys.productInStores.getStockQuantity,
      [productId, storeId],
      (error, results, fields) => {
